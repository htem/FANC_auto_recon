...
def fanc4_to_3(points,scale=2):
    ...
    Inputs:
             points: (np.array) an nx3 array of mip0 pixel coordinates
             scale:  (int) From Eric: selects the granularity of the field being used, but does not change the units.

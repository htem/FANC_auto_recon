...
class SomaTableOrganizer(object):
    ...
    def initialize(self,
        ...
        txt_msg = """\
            ...
            When you upload somas locating slightly outside the dataset and ventral, use the coordinates on z=10 slice.""".format(self._soma_table_name, self._subset_table_name, self._required_props())
